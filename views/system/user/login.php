<form class="uk-form uk-form-stacked uk-article uk-width-medium-2-3 uk-width-large-1-2 uk-container-center" action="<?= $view->url('@user/authenticate') ?>" method="post">
