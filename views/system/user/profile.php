...
<form id="user-profile" class="uk-form uk-form-stacked uk-article uk-width-medium-2-3 uk-width-large-1-2 uk-container-center" v-validator="form" @submit.prevent="save | valid">
